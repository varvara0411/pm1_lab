...
plt.xlabel('Размер массива (элементы)', fontsize=12)
plt.ylabel('Время сортировки (мс, логарифмически)', fontsize=12)
plt.title('Сравнение алгоритмов сортировки (без shakersort)', fontsize=14)
plt.legend()

plt.savefig("sort_comparison_three.png", dpi=300, bbox_inches='tight')
plt.show()