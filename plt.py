...
# --- Graph without shakerSort and std::sort---
plt.figure(figsize=(12, 7))
...
plt.xlabel('Размер массива (элементы)', fontsize=12)
plt.ylabel('Время сортировки (мс)', fontsize=12)
plt.title('Сравнение алгоритмов сортировки (без shakersort и std::sort)', fontsize=14)
plt.legend()

plt.savefig("sort_comparison_two.png", dpi=300, bbox_inches='tight')
plt.show()